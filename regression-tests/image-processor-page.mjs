...
assert.match(page, /class="form-row"/);
assert.match(page, /max-width:\s*320px/);
...
assert.equal(history.includes('<!-- 版本 2.15.2 -->'), false);
assert.equal(history.includes('<!-- 版本 2.15.1 -->'), false);
